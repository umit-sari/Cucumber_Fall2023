...
public class SaucedemoStepdefinitions {
    ...
    @Then("Usarname kutusuna {string} yazar")
    public void usarname_kutusuna_yazar(String gecerliUsername) {
    ...
    public void ilk_urunun_ismini_kaydeder_ve_bu_urunun_sayfasina_tiklar() {
